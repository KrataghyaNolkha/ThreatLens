...
const colors = {
  ...
  error: '#dc2626',
  info: '#2563eb',
  text: '#0f172a',        // Deep Slate for high-visibility headings
...
const LandingPage = () => {
  ...
  const [faqItems] = useState([
    ...
    { question: 'Does ThreatLens automatically neutralize threats?', answer: 'Yes, our adaptive defenses can automatically mitigate common attacks, such as quarantining malicious inputs or blocking suspicious traffic.' },
    { question: 'How can I integrate ThreatLens with my SecOps tools?', answer: 'We support seamless integrations with popular SecOps and CI/CD tools, allowing you to centralize AI security in your existing workflows.' },
    { question: 'What compliance frameworks does ThreatLens support?', answer: 'ThreatLens is designed to support various frameworks, including GDPR, HIPAA, and CCPA, and provides detailed reports and controls to aid your compliance efforts.' },
  ]);
  ...
  return (
    <Box sx={{ bgcolor: colors.background, minHeight: '100vh', fontFamily: bodyFont }}>
      {/* Navigation */}
      <AppBar position="fixed" elevation={0} sx={{ bgcolor: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(12px)', borderBottom: `1px solid ${colors.border}` }}>
        <Container maxWidth="lg" sx={{ px: { xs: 3, md: 6 } }}>
          <Toolbar disableGutters sx={{ justifyContent: 'space-between', height: 80 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, cursor: 'pointer' }} onClick={() => navigate('/')}>
              <Box sx={{ width: 32, height: 32, bgcolor: colors.primary, borderRadius: 1, transform: 'rotate(45deg)' }} />
              <Typography variant="h6" sx={{ fontWeight: 800, color: colors.text, ml: 1 }}>ThreatLens</Typography>
            </Box>
          ...
          <Grid container spacing={8} alignItems="center">
            <Grid item xs={12} md={6}>
              <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
                ...
                <Typography variant="h1" sx={{ fontFamily: headingFont, fontSize: { xs: '2.8rem', md: '4rem' }, fontWeight: 900, color: colors.text, lineHeight: 1.1, mt: 2, mb: 3 }}>
                ...
                <Stack direction="row" spacing={2}>
                  <Button variant="contained" size="large" sx={{ bgcolor: colors.primary, px: 4, py: 1.8, borderRadius: 2, textTransform: 'none', fontSize: '1.1rem', fontWeight: 700 }} onClick={() => navigate('/dashboard')}>
                    Get Started Free
                  </Button>
      ...
      <Box sx={{ py: 15, bgcolor: colors.surface }}>
        <Container maxWidth="lg" sx={{ px: { xs: 4, md: 10 } }}>
          <Box sx={{ textAlign: 'center', mb: 10 }}>
            <Typography variant="h2" sx={{ fontFamily: headingFont, fontWeight: 800, mb: 2, color: colors.text }}>Unified Security Solutions</Typography>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              <Box sx={{ bgcolor: colors.primary, p: 6, borderRadius: 6, color: '#fff', height: '100%' }}>
                <Typography variant="h4" sx={{ fontFamily: headingFont, fontWeight: 800, mb: 3, color: '#fff' }}>Compliance Ready</Typography>
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ bgcolor: colors.darkSurface, p: 6, borderRadius: 6, color: '#fff', height: '100%' }}>
                <Typography variant="h4" sx={{ fontFamily: headingFont, fontWeight: 800, mb: 3, color: '#fff' }}>Agent Visibility</Typography>
      ...
      {/* FAQ */}
      <Box sx={{ py: 15, bgcolor: colors.surface }}>
        <Container maxWidth="md" sx={{ px: { xs: 4, md: 6 } }}>
          <Typography variant="h3" sx={{ fontFamily: headingFont, fontWeight: 800, mb: 6, textAlign: 'center', color: colors.text }}>Questions?</Typography>
          {faqItems.map((item, i) => (
      ...
      <Box sx={{ py: 10, borderTop: `1px solid ${colors.border}` }}>
        <Container maxWidth="lg" sx={{ px: { xs: 4, md: 8 } }}>
          <Grid container spacing={4} justifyContent="space-between">
            <Grid item xs={12} md={4}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                ...
                <Typography variant="h6" sx={{ fontWeight: 800, color: colors.text }}>ThreatLens</Typography>
              </Box>
            ...
            <Grid item xs={6} md={2}>
              <Typography variant="subtitle2" sx={{ fontWeight: 700, mb: 2, color: colors.text }}>Product</Typography>
            ...
            <Grid item xs={6} md={2}>
              <Typography variant="subtitle2" sx={{ fontWeight: 700, mb: 2, color: colors.text }}>Company</Typography>
          ...
          <Typography variant="caption" sx={{ color: colors.textSecondary }}>
            © 2026 ThreatLens Security Inc. All rights reserved.
          </Typography>
        </Container>
      </Box>
    </Box>
